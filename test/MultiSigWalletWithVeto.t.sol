...
contract MultiSigWalletWithVetoTest is Test {
    ...
    function test_ExecuteTransaction() public {
        // Create a proposal
        vm.prank(owner1);
        uint256 proposalId = wallet.proposeTransaction(address(target), 0, abi.encodeWithSelector(target.setValue.selector, 42));
    ...
    function test_ExecutionFailedEvent() public {
        ...
        uint256 proposalId = wallet.proposeTransaction(
            ...
            0,
            abi.encodeWithSelector(revertingContract.alwaysReverts.selector)
        );
