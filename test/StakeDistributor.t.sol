...
contract StakeDistributorTest is Test {
    ...
    function test_Initialize() public {
        ...
        bytes memory initData = abi.encodeWithSelector(
            distributor.initialize.selector, COLDKEY, HOTKEY, NETUID, targets, INITIAL_STAKE, MIN_INTERVAL
        );
    ...
    function test_ReportManualStakeChange() public {
        ...
        bytes memory reportData = abi.encodeWithSelector(distributor.reportManualStakeChange.selector, increase);
        ...
        bytes memory reportData2 = abi.encodeWithSelector(distributor.reportManualStakeChange.selector, decrease);
    ...
    function test_ConfirmApyDistributionExecuted() public {
        ...
        bytes memory confirmData = abi.encodeWithSelector(
            distributor.confirmApyDistributionExecuted.selector, totalDistributed, newStakeBalance
        );
    ...
    function test_UpdateDistributionTargets() public {
        ...
        bytes memory updateData = abi.encodeWithSelector(distributor.updateDistributionTargets.selector, newTargets);
    ...
    function test_UpdateMinDistributionInterval() public {
        ...
        bytes memory updateData =
            abi.encodeWithSelector(distributor.updateMinDistributionInterval.selector, newInterval);
    ...
    function test_TransferOwnership() public {
        ...
        bytes memory transferData = abi.encodeWithSelector(distributor.transferOwnership.selector, newOwner);
    ...
    function test_RevertWhen_InvalidDistributionTargets() public {
        ...
        bytes memory updateData1 =
            abi.encodeWithSelector(distributor.updateDistributionTargets.selector, invalidTargets1);
        ...
        bytes memory updateData2 =
            abi.encodeWithSelector(distributor.updateDistributionTargets.selector, invalidTargets2);
        ...
        bytes memory updateData3 =
            abi.encodeWithSelector(distributor.updateDistributionTargets.selector, invalidTargets3);
